...
\usepackage[citebordercolor={1 1 1}, filebordercolor={1 1 1}, linkbordercolor={1 1 1}, menubordercolor={1 1 1}, urlbordercolor={1 1 1}, plainpages=true, bookmarks=true, breaklinks, pdfstartview=FitH,pdftitle={Nome da Teste},pdfauthor={Nome do autor},pdfsubject={Assunto do documento},pdfkeywords={Palavras-chave}]{hyperref}
...
\comentario{\UTFPRdocumentodata\ apresentada ao \UTFPRprogramadata\ da \ABNTinstituicaodata\ como requisito parcial para obtenÃ§Ã£o do tÃ­tulo de ``\UTFPRtitulacaodata\ em Engenharia ElÃ©trica'' -- Ãrea de ConcentraÃ§Ã£o: \UTFPRareadata.}
